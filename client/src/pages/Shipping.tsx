      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 prose prose-blue max-w-none">
          ...
          <p>
            ...
            Orissa Academy Trust. As an educational trust, we rely on the generosity of donors to support our 
          ...
          <p>
            Orissa Academy Trust accepts monetary donations through various channels, including:
          </p>
          <ul>
          ...
          <p>
            Donations to Orissa Academy Trust are used to support our educational programs and initiatives, including:
          </p>
          <ul>
          ...
          <p>
            Donations to Orissa Academy Trust are eligible for tax deductions under Section 80G of the Income Tax Act 
          ...
          <p>
            Orissa Academy Trust recognizes and appreciates the support of our donors in the following ways:
          </p>
          <ul>
          ...
          <p>
            Orissa Academy Trust is committed to protecting the privacy of our donors. We do not sell, trade, or 
          ...
          <p>
            Orissa Academy Trust reserves the right to modify this Donation Policy at any time. Any changes will be 
